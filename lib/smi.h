 ...
 * smi.h --
 *
 *      Interface Definition of libsmi (version 2:6:0).
 *
...
#define SMI_LIBRARY_VERSION "2:6:0"
extern const char *smi_library_version;

#define SMI_VERSION_MAJOR 0
#define SMI_VERSION_MINOR 2
#define SMI_VERSION_PATCHLEVEL 6
#define SMI_VERSION_STRING "0.2.6"
...
#define SMI_FLAG_BE_LAX   0x10000 /* allow some illegal chars in identifiers */
#define SMI_FLAG_MASK      (SMI_FLAG_NODESCR|SMI_FLAG_VIEWALL|SMI_FLAG_STATS|\
			    SMI_FLAG_RECURSIVE|SMI_FLAG_ERRORS|SMI_FLAG_BE_LAX)
...
typedef unsigned long           SmiUnsigned64;
typedef long                    SmiInteger64;
#else
