...
static void fprintTcList(FILE *f, int modc, SmiModule **modv)
{
    SmiType     *smiType;
...
static void dumpTcList(int modc, SmiModule **modv, int flags, FILE *f)
{
    ...
    if (flags & SMIDUMP_FLAG_UNITE) {
    	...
    	if (! (flags & SMIDUMP_FLAG_SILENT)) {
	    fprintComment(f,
		  "# united textual convention list (generated by smidump "
			  SMI_VERSION_STRING ")");
	}
	...
	for (i = 0; i < modc; i++) {
	    ...
	    if (! (flags & SMIDUMP_FLAG_SILENT)) {
		smiAsprintf(&comment,
		    "# %s textual convention list (generated by smidump "
		     ...
		     char *output)
{
	...
	fprintf(f,
		...
		"<?rfc compact='yes'?>\n"
		"\n",
		tc_list ? "textual-convention-list.txt"
		        : boilerplate ? "boilerplate.txt" : "unknown.txt");

	fprintf(f,
		"  <front>\n"
		"    <title>List of Textual Conventions</title>\n"
	...
	if (tc_list) {
	    fprintf(f,
		    "    <abstract>\n"
		    "      <t>\n"
		    "        List of Textual Conventions. This file has been\n"
		    "        generated by smidump. Do not edit.\n"
		    "     </t>\n"
		    "    </abstract>\n");
	}
	fprintf(f,
...
void initIetf()
{
	...
	{ "tc-list", OPT_FLAG, &tc_list, 0,
	  "generate a list of textual conventions" },
	{ "boilerplate", OPT_FLAG, &boilerplate, 0,
	  "generate security considerations boilerplate" },
	{ "xml2rfc", OPT_FLAG, &xml, 0,
	  "generate output in xml2rfc format" },
        { 0, OPT_END, 0, 0 }
    };
